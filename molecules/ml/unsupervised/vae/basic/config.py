...
class BasicVAEModelConfig(BaseSettings):
    ...
    wandb_project_name: Optional[str] = "mpro-experiments"
    # Team name for wandb logging
    wandb_entity_name: Optional[str] = "sars-cov-2-research"
    # Model tag for wandb labeling
    model_tag: Optional[str] = None


if __name__ == "__main__":
    BasicVAEModelConfig().dump_yaml("basic_vae_template.yaml")
