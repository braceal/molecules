...
from molecules.ml.unsupervised.vae import VAE, ResnetVAEHyperparams

from molecules.ml.unsupervised.vae.resnet.config import ResnetVAEModelConfig


def main(cfg: ResnetVAEModelConfig, encoder_gpu: int, decoder_gpu: int):
    ...
    hparams = ResnetVAEHyperparams(
        ...
        enc_reslayers=cfg.enc_reslayers,
        scale_factor=cfg.scale_factor,
        dec_reslayers=cfg.dec_reslayers,
        dec_kernel_size=cfg.dec_kernel_size,
        dec_filters=cfg.dec_filters,
        dec_filter_growth_rate=cfg.dec_filter_growth_rate,
    )
...
if __name__ == "__main__":
    args = parse_args()
    cfg = ResnetVAEModelConfig.from_yaml(args.config)
