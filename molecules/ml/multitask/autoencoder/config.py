...
from molecules.config import ModelBaseConfig, OptimizerConfig


class MultiTaskAutoEncoderModelConfig(ModelBaseConfig):
    ...
    # Multi-task models
    rmsd_loss_function: str = "mse"
    rmsd_loss_reduction: str = "sum"
